        ...
        <center>
                  <ul class="pagination">
                        <?php if($numpage == 1){ ?>
                              ...
                              <li><a href="series_kor.php?numkor=<?php echo $numpage-1 ?>">Previous</a></li> <?php } ?>
                        ...
                        <?php if($numpage*9 > count($get)){ ?>
                              ...
                              <li><a href="series_kor.php?numkor=<?php echo $numpage+1 ?>">Next</a></li> <?php } ?>
                  </ul>
            </center>
